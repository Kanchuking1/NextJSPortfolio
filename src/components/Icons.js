...
export const SearchIcon = ({className="", ...rest}) => (
  <svg
    ...
    {...rest}
  >
    <path d="M52.35 14.4c-9.725 0-19.45 3.7-26.85 11.1-14.8 14.8-14.8 38.9 0 53.7 7.4 7.4 17.1 11.1 26.9 11.1 9.8 0 19.5-3.7 26.9-11.1C94 64.4 94 40.3 79.2 25.5c-7.4-7.4-17.125-11.1-26.85-11.1zm-.05 5.9c8.2 0 16.4 3.1 22.6 9.4C87.4 42.2 87.4 62.5 75 75c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3a31.97 31.97 0 0 1 22.6-9.4zm0 6C45.4 26.3 38.9 29 34 34c-4.7 4.7-7.3 10.8-7.6 17.4-.1 1.7 1.2 3 2.9 3.1h.1c1.6 0 2.9-1.3 3-2.9.2-5.1 2.3-9.8 5.8-13.4 3.8-3.8 8.8-5.9 14.1-5.9 1.7 0 3-1.3 3-3s-1.3-3-3-3zM35 64a3 3 0 0 0-3 3 3 3 0 0 0 3 3 3 3 0 0 0 3-3 3 3 0 0 0-3-3zm48.363 16.5c-.762 0-1.512.3-2.062.9-1.2 1.2-1.2 3.1 0 4.2l2.5 2.5c-.6 1.2-.9 2.5-.9 3.9 0 2.4.899 4.7 2.599 6.4L98.3 111c1.8 1.8 4.1 2.7 6.4 2.7 2.3 0 4.6-.9 6.4-2.6 3.5-3.5 3.5-9.2 0-12.7L98.3 85.6c-1.7-1.7-4-2.6-6.4-2.6-1.4 0-2.7.3-3.9.9l-2.5-2.5c-.6-.6-1.374-.9-2.137-.9zm8.537 8.4c.8 0 1.6.3 2.1.9l12.7 12.7c1.2 1.2 1.2 3.1 0 4.2-1.2 1.2-3.1 1.2-4.2 0L89.8 94.1c-.6-.6-.9-1.4-.9-2.2 0-.8.3-1.6.9-2.1.6-.6 1.3-.9 2.1-.9z" />
  </svg>
)